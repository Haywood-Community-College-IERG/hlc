...
### 1. Official Communications {#sec-official-communications}
...
### 3. Reaffirmation of Accreditation {#sec-reaffirmation-of-accreditation}
...
### 4. Sanction Status {#sec-sanction-status}
...
### 5. USED Approval {#sec-used-approval}
...
### 6. Substantial Presence Worksheet {#sec-substantial-presence-worksheet}
...
### 7. Incorporation Documentation {#sec-incorporation-documentation}
...
### 8. Degree Authorization {#sec-degree-authorization}
...
### 10. Enrollment Information {#sec-enrollment-information}
...
### 11. Accreditor Relationships {#sec-accreditor-relationships}
...
## Other topics of interest {#sec-other-topics}

- Learn about the responsibilities of the Accreditation Liaison Office[^s2_hlc_alo]

## Actual Sample Applications {#sec-actual-sample-applications}
...
- Added tips for \nameref{sec-incorporation-documentation} and \nameref{sec-degree-authorization}.
- Added tips for \nameref{sec-educational-programs-list}.
